...
<form action='/zonas/{{$zona->id}}' method='POST' id='formulario-guardar'>
  @csrf
  @method('PUT')
<div class="mb-3">
    <label for="nomSuc" class="form-label">Nombre departamento</label>
    <input type="text" class="form-control" id="nomSuc" name = 'nomZona' value ='{{$zona->descripcion}}' aria-describedby="emailHelp">
  </div>
